...
void RcvInit(void) {
  ...
  GPIOB->PUPDR |=
      ...
      GPIO_PUPDR_PUPDR6_1 | GPIO_PUPDR_PUPDR7_1 | GPIO_PUPDR_PUPDR8_1 |
      GPIO_PUPDR_PUPDR9_1 | GPIO_PUPDR_PUPDR10_1;
  ...
  GPIOB->OSPEEDR |=
      ...
      GPIO_OSPEEDER_OSPEEDR6 | GPIO_OSPEEDER_OSPEEDR7 | GPIO_OSPEEDER_OSPEEDR8 |
